"""
Extract GA4 traffic sources by month for investor report.
Period: May 2025 - April 2026 (12 full months).
For each month: channel groups, top sources, and key metrics.
Output: ga4_monthly_traffic_extended.json
"""
...
OUTPUT_FILE = os.path.join(SCRIPT_DIR, 'ga4_monthly_traffic_extended.json')

MONTHS = [
    {"name": "Mai 2025",        "start": "2025-05-01", "end": "2025-05-31"},
    {"name": "Iunie 2025",      "start": "2025-06-01", "end": "2025-06-30"},
    {"name": "Iulie 2025",      "start": "2025-07-01", "end": "2025-07-31"},
    {"name": "August 2025",     "start": "2025-08-01", "end": "2025-08-31"},
    {"name": "Septembrie 2025", "start": "2025-09-01", "end": "2025-09-30"},
    {"name": "Octombrie 2025",  "start": "2025-10-01", "end": "2025-10-31"},
    {"name": "Noiembrie 2025",  "start": "2025-11-01", "end": "2025-11-30"},
    {"name": "Decembrie 2025",  "start": "2025-12-01", "end": "2025-12-31"},
    ...
    {"name": "Aprilie 2026",    "start": "2026-04-01", "end": "2026-04-30"},
]
...
if __name__ == '__main__':
    logging.info("Extracting extended monthly traffic data (May 2025 - April 2026)...")
